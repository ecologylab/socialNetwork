...
class HttpBasicCookie(HttpBasicAuthentication):
    def __init__(self, *args, **kwargs):
        super(HttpBasicCookie, self).__init__(*args, **kwargs)
    ...
    def is_authenticated(self, request, **kwargs):
		...
		u = User.objects.get(id=s.get_decoded()['_auth_user_id'])
                request.user = u
                return True
        return super(HttpBasicCookie, self).is_authenticated(request, **kwargs)
